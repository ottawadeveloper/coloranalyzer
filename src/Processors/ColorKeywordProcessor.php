...
/**
 * Responsible for transforming a color string, based on the standard CSS
 * keywords.
 * 
 * @package color_processing
 */
class ColorKeywordProcessor implements \OttawaDeveloper\Tools\ColorAnalyzer\ColorProcessor {
  
  /**
   * @var array
   */
  private static $colorKeywords = array(
    'aliceblue' => '#f0f8ff',
    'antiquewhite' => '#faebd7',
    'aqua' => '#00ffff',
    'aquamarine' => '#7fffd4',
